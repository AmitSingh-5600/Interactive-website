!(function (t, e) {
  ...
  return (function (t) {
        ...
        (i = function () {
          ...
          })(
            {
                ...
                function (t, n, r) {
                  ...
                  (c.prototype.setScheduler = function (t) {
                    ...
                    a.hasDevTools
                      ...
                      : ((c.prototype.invokeLater = l),
                        (c.prototype.invoke = u),
                  ...
                  n.exports = function (n, r) {
                    var i,
                      ...
                      k =
                        ...
                        (b || !!u.env("BLUEBIRD_W_FORGOTTEN_RETURN"));
                    (n.prototype.suppressUnhandledRejections = function () {
                      ...
                      (n.prototype._notifyUnhandledRejectionIsHandled =
                        function () {
                          G("rejectionHandled", i, void 0, this);
                        }),
                    ...
                    (n.longStackTraces = function () {
                      ...
                      if (!Y.longStackTraces && W()) {
                        ...
                        (Y.longStackTraces = !0),
                          ...
                          (n.prototype._attachExtraTrace = N),
                          (n.prototype._dereferenceTrace = $),
                          r.activateLongStackTraces(),
                          c.disableTrampolineIfNecessary();
                      }
                    }),
                      (n.hasLongStackTraces = function () {
                        return Y.longStackTraces && W();
                      });
                    var j = (function () {
                        try {
                      ...
                      C = u.isNode
                        ...
                        ? function (t) {
                            ...
                            return (
                              !!n &&
                              (n.apply(u.global, [].slice.call(arguments, 1)),
                              !0)
                            );
                          }
                        : function () {
                    ...
                    (n.config = function (t) {
                      ...
                      if (
                        ...
                        (n.prototype._clearCancellationData = L),
                          (n.prototype._propagateFrom = I),
                          (n.prototype._onCancel = R),
                          (n.prototype._setOnCancel = A),
                          (n.prototype._attachCancellationCallback = P),
                      ...
                      return (
                        "monitoring" in t &&
                          (t.monitoring && !Y.monitoring
                            ? ((Y.monitoring = !0),
                              (n.prototype._fireEvent = S))
                            : !t.monitoring &&
                              Y.monitoring &&
                              ((Y.monitoring = !1),
                              (n.prototype._fireEvent = F))),
                        n
                      );
                    }),
                      (n.prototype._fireEvent = F),
                    ...
                    function G(t, e, n, r) {
                      ...
                      "unhandledRejection" === t
                        ? S(t, n, r) || i || z(n, "Unhandled rejection ")
                        : S(t, r);
                    }
                    function q(t) {
                      var e;
                ...
                function (t, n, r) {
                  ...
                  n.exports = function () {
                    ...
                    (a = l.isNode
                      ...
                      l.notEnumerableProp(F, "_getDomain", a);
                    var u = t("./es5"),
                      f = t("./async"),
                      p = new f();
                    u.defineProperty(F, "_async", { value: p });
                    var h = t("./errors"),
                      d = (F.TypeError = h.TypeError);
                    F.RangeError = h.RangeError;
                    var _ = (F.CancellationError = h.CancellationError);
                    (F.TimeoutError = h.TimeoutError),
                      (F.OperationalError = h.OperationalError),
                      (F.RejectionError = h.OperationalError),
                      (F.AggregateError = h.AggregateError);
                    var v = function () {},
                      y = {},
                      g = {},
                      m = t("./thenables")(F, v),
                      b = t("./promise_array")(F, v, m, o, s),
                      w = t("./context")(F),
                      k = w.create,
                      x = t("./debuggability")(F, w),
                      j = (x.CapturedTrace, t("./finally")(F, m, g)),
                      C = t("./catch_filter")(g),
                      E = t("./nodeback"),
                      T = l.errorObj,
                      S = l.tryCatch;
                    function F(t) {
                      t !== v &&
                        (function (t, e) {
                          if (null == t || t.constructor !== F)
                            throw new d(
                              "the promise constructor cannot be invoked directly\n\n    See http://goo.gl/MqrFmX\n"
                            );
                          if ("function" != typeof e)
                            throw new d(
                              "expecting a function but got " + l.classString(e)
                            );
                        })(this, t),
                        (this._bitField = 0),
                    ...
                    return (
                      ...
                      (F.prototype.caught = F.prototype.catch =
                        function (t) {
                          ...
                          if (e > 1) {
                            ...
                            return this.then(void 0, C(r, t, this));
                          }
                      ...
                      (F.prototype._then = function (t, e, n, r, i) {
                        var o = void 0 !== i,
                          s = o ? i : new F(v),
                          c = this._target(),
                          u = c._bitField;
                      ...
                      (F.prototype._migrateCallback0 = function (t) {
                        t._bitField;
                          ...
                          (this._promise0 = n),
                            ...
                            "function" == typeof t &&
                              (this._fulfillmentHandler0 =
                                null === i ? t : l.domainBind(i, t)),
                            "function" == typeof e &&
                              (this._rejectionHandler0 =
                                null === i ? e : l.domainBind(i, e));
                        else {
                          var s = 4 * o - 4;
                          (this[s + 2] = n),
                            (this[s + 3] = r),
                      ...
                      (F.prototype._settlePromise = function (t, e, n, r) {
                        ...
                        0 != (65536 & a)
                          ? (o && t._invokeInternalOnCancel(),
                            n instanceof j && n.isFinallyHandler()
                              ? ((n.cancelPromise = t),
                                S(e).call(n, r) === T && t._reject(T.e))
                              : e === i
                              ? t._fulfill(i.call(n))
                              : n instanceof s
                          ...
                          : o &&
                            (c && t._setAsyncGuaranteed(),
                            0 != (33554432 & a) ? t._fulfill(r) : t._reject(r));
                      }),
                      (F.prototype._settlePromiseLateCancellationObserver =
                        function (t) {
                          var e = t.handler,
                            n = t.promise,
                            r = t.receiver,
                      ...
                      (F.prototype._reject = function (t) {
                        ...
                        if (!((117506048 & e) >>> 16)) {
                          if (
                            ...
                            return p.fatalError(t, l.isNode);
                          (65535 & e) > 0
                            ? p.settlePromises(this)
                      ...
                      "undefined" != typeof Symbol &&
                        Symbol.toStringTag &&
                        u.defineProperty(F.prototype, Symbol.toStringTag, {
                          get: function () {
                            return "Object";
                          },
                        }),
                      (F.defer = F.pending =
                        function () {
                          return (
                            ...
                            { promise: new F(v), resolve: O, reject: P }
                          );
                        }),
                      l.notEnumerableProp(F, "_makeSelfResolutionError", r),
                      t("./method")(F, v, m, o, x),
                      t("./bind")(F, v, m, x),
                      t("./cancel")(F, b, o, x),
                      t("./direct_resolve")(F),
                      t("./synchronous_inspection")(F),
                      t("./join")(F, b, m, v, p, a),
                      (F.Promise = F),
                      (F.version = "3.5.5"),
                      t("./call_get.js")(F),
                      t("./generators.js")(F, o, v, m, s, x),
                      t("./map.js")(F, b, o, m, v, x),
                      t("./nodeify.js")(F),
                      t("./promisify.js")(F, v),
                      t("./props.js")(F, b, m, o),
                      t("./race.js")(F, v, m, o),
                      t("./reduce.js")(F, b, o, m, v, x),
                      t("./settle.js")(F, b, x),
                      t("./some.js")(F, b, o),
                      t("./timers.js")(F, v, x),
                      t("./using.js")(F, o, m, k, v, x),
                      t("./any.js")(F),
                      t("./each.js")(F, v),
                      t("./filter.js")(F, v),
                      l.toFastProperties(F),
                      l.toFastProperties(F.prototype),
                      R({ a: 1 }),
                      R({ b: 2 }),
                      R({ c: 3 }),
                      R(1),
                      ...
                      R(!1),
                      R(new F(v)),
                      x.setBounds(f.firstLineError, l.lastLineError),
                      F
                    );
                  };
                },
                ...
                function (t, e, n) {
                  ...
                  e.exports = function (e, n, r, i) {
                    ...
                    function a(t, a) {
                      ...
                      for (
                        var u = l._fulfill, f = l._reject, p = 0, h = t.length;
                        p < h;
                        ++p
                      ) {
                        var d = t[p];
                        (void 0 !== d || p in t) &&
                          e.cast(d)._then(u, f, void 0, l, null);
                      }
                      return l;
                    }
                    (e.race = function (t) {
                  ...
                  e.exports = function (e, n, r, i, o, s) {
                    ...
                    function p(t, e, n, i) {
                      return "function" != typeof e
                        ? r("expecting a function but got " + c.classString(e))
                        : new u(t, e, n, i).promise();
                    }
                    function h(t) {
                      ...
                      (e.using = function () {
                        ...
                        var w = e.all(b).then(function (t) {
                            ...
                            var r = c ? o.apply(void 0, t) : o(t),
                              i = k._popContext();
                            return (
                              s.checkForgottenReturns(r, i, "Promise.using", k),
                              r
                            );
                          }),
                          k = w.lastly(function () {
              ...
              36: [
                function (t, r, i) {
                  ...
                  function P(t) {
                    return S(t) && o.propertyIsWritable(t, "stack");
                  }
                  var R =
                    "stack" in new Error()
                      ? function (t) {
                          return P(t) ? t : new Error(T(t));
                        }
                      : function (t) {
                          if (P(t)) return t;
                          try {
                  ...
                  var H =
                      void 0 !== e && "[object process]" === A(e).toLowerCase(),
                  ...
                  (V.isRecentNode =
                    ...
                    (e.versions && e.versions.node
                      ? (U = e.versions.node.split(".").map(Number))
                      : e.version && (U = e.version.split(".").map(Number)),
                    (0 === U[0] && U[1] > 10) || U[0] > 0)),
          ...
          "undefined" != typeof window && null !== window
            ...
            : "undefined" != typeof self &&
              null !== self &&
              (self.P = self.Promise);
      }).call(this, n(2), n(3), n(7).setImmediate);
    },
    function (t, e) {
      var n,
        r,
    ...
    function (t, e, n) {
      (e.markdown = n(9)), (e.parse = e.markdown.toHTML);
    },
    function (t, e) {
    ...
    function (t, e, n) {
      !(function (t) {
          ...
          (t.toHTMLTree = function (t, e, n) {
            ...
            return (
              (function t(e) {
                ...
                for (; n < e.length; )
                  "string" == typeof e[n]
                    ? n + 1 < e.length && "string" == typeof e[n + 1]
                      ? (e[n] += e.splice(n + 1, 1)[0])
                      : ++n
                    : (t(e[n]), ++n);
              })(o),
              o
        ...
        function c(t, e) {
          ...
          return function (o, s) {
            if (this[n][0] == e)
              return this[n].shift(), [o.length, new i(o.length - e.length)];
            var a = this[r].slice(),
              c = this[n].slice();
            this[n].unshift(e);
            ...
            return u instanceof i
              ? (l.pop(), [o.length - u.len_after, [t].concat(l)])
              : ((this[r] = a), (this[n] = c), [e.length, e]);
          };
        }
        (e.prototype.split_blocks = function (t, e) {
          ...
          (e.dialects.Gruber = {
            block: {
              atxHeader: function (t, e) {
                ...
                if (n) {
                  ...
                  return (
                    ...
                    n[0].length < t.length &&
                      e.unshift(
                        o(t.substr(n[0].length), t.trailing, t.lineNumber + 2)
                      ),
                    [r]
                  );
                }
              ...
              lists: (function () {
                ...
                function s(t, e) {
                  for (
                    var n = new RegExp("^(" + r + "{" + t + "}.*?\\n?)*$"),
                      i = new RegExp("^" + r + "{" + t + "}", "gm"),
                      s = [];
                    e.length > 0 && n.exec(e[0]);
                ...
                return function (o, c) {
                  ...
                  if (u) {
                    for (
                      var f, p, h, d = [], _ = F(u), v = !1, y = [d[0].list];
                      ;
                      ...
                      for (
                        ...
                        if (void 0 !== (u = k.match(x))[1]) {
                          m.length &&
                            (i(f, v, this.processInline(m), w),
                            (v = !1),
                            (m = "")),
                            (u[1] = u[1].replace(/ {0,3}\t/g, "    "));
                          var j = Math.floor(u[1].length / 4) + 1;
                          if (j > d.length)
                            (_ = F(u)), f.push(_), (f = _[1] = ["listitem"]);
                          else {
                            var C = !1;
                            for (p = 0; p < d.length; p++)
                              if (d[p].indent == u[1]) {
                                (_ = d[p].list),
                                  d.splice(p + 1, d.length - (p + 1)),
                                  (C = !0);
                                break;
                              }
                            C ||
                      ...
                      m.length &&
                        (i(f, v, this.processInline(m), w), (v = !1), (m = ""));
                      var E = s(d.length, c);
                      E.length > 0 &&
                        (l(d, a, this), f.push.apply(f, this.toTree(E, [])));
                      var T = (c[0] && c[0].valueOf()) || "";
                      if (!T.match(n) && !T.match(/^ /)) break;
                      o = c.shift();
                      var S = this.dialect.block.horizRule(o, c);
                      if (S) {
                        y.push.apply(y, S);
                        break;
                      }
                  ...
                  function F(t) {
                    ...
                    return d.push({ list: n, indent: t[1] }), n;
                  }
                };
              })(),
                ...
                if (t.match(/^>/m)) {
                  ...
                  if (">" != t[0]) {
                    for (
                      ...
                      i.push(r.shift()), s++;
                    var a = o(i.join("\n"), "\n", t.lineNumber);
                    n.push.apply(n, this.processBlock(a, [])),
                      (t = o(r.join("\n"), t.trailing, s));
                  }
                  for (; e.length && ">" == e[0][0]; ) {
                    var c = e.shift();
          ...
          (e.dialects.Gruber.inline = {
            __oneElement__: function (t, e, n) {
              ...
              return (
                ...
                (r = new RegExp("([\\s\\S]*?)(" + (e.source || e) + ")").exec(
                  t
                ))
                  ? r[1]
                    ? [r[1].length, r[1]]
            ...
            __call__: function (t, e) {
              ...
              for (; t.length > 0; )
                (n = this.dialect.inline.__oneElement__.call(this, t, e, r)),
                  (t = t.substr(n.shift())),
                  l(n, i);
              return r;
            },
            ...
            "![": function (t) {
              ...
              if (e) {
                ...
                return (
                  void 0 !== e[4] && (n.title = e[4]), [e[0].length, ["img", n]]
                );
              }
              return (e = t.match(/^!\[(.*?)\][ \t]*\[(.*?)\]/))
                ? [
                    ...
                    [
                      "img_ref",
                      { alt: e[1], ref: e[2].toLowerCase(), original: e[0] },
                    ],
                  ]
                : [2, "!["];
            },
            "[": function (t) {
                ...
                if (
                  ...
                  for (var u = 1, f = 0; f < l.length; f++)
                    switch (l[f]) {
                      ...
                      case ")":
                        0 == --u &&
                          ((s -= l.length - f), (l = l.substring(0, f)));
                    }
                return (
                  (o = {
                    href:
                      (l = this.dialect.inline.__call__.call(
                        this,
                        l,
                        /\\/
                      )[0]) || "",
                  }),
                  void 0 !== c[3] && (o.title = c[3]),
                  (i = ["link", o].concat(a)),
                  [s, i]
                );
              }
              return (c = t.match(/^\s*\[(.*?)\]/))
                ...
                ? ((i = [
                    "link_ref",
                    (o = { ref: a[0].toLowerCase(), original: n.substr(0, s) }),
                    a[0],
                  ]),
                  [s, i])
                : [1, "["];
            ...
            "<": function (t) {
              ...
              return null !=
                ...
                ? e[3]
                  ? [e[0].length, ["link", { href: "mailto:" + e[3] }, e[3]]]
                  : "mailto" == e[2]
                  ? [
                      e[0].length,
                      ["link", { href: e[1] }, e[1].substr("mailto:".length)],
                    ]
          ...
          (e.dialects.Maruku.block.block_meta = function (t, e) {
            ...
            if (n) {
              ...
              for (a in ((r = h(c[0])) || ((r = {}), c[0].splice(1, 0, r)), i))
                r[a] = i[a];
              return c;
            }
          }),
          ...
          (e.dialects.Maruku.block.table = function (t, e) {
            ...
            for (
              ...
              o[1][1].push(
                ["th", s[n] || {}].concat(this.processInline(r[1][n].trim()))
              );
            return (
              l(
                ...
                function (t) {
                  var e = ["tr"];
                  for (t = i(t, "|"), n = 0; n < t.length; n++)
                    e.push(
                      ["td", s[n] || {}].concat(this.processInline(t[n].trim()))
                    );
                  o[2].push(e);
                },
                this
    ...
    function (t, e, n) {
      (function (t) {
        ...
        function u(t, n, r) {
          ...
          return (
            m(n) && (b = " " + RegExp.prototype.toString.call(n)),
            w(n) && (b = " " + Date.prototype.toUTCString.call(n)),
            k(n) && (b = " " + f(n)),
            0 !== s.length || (j && 0 != n.length)
              ? r < 0
                ? m(n)
        ...
        function m(t) {
          return b(t) && "[object RegExp]" === j(t);
        }
        function b(t) {
          return "object" == typeof t && null !== t;
        }
        function w(t) {
          return b(t) && "[object Date]" === j(t);
        }
        function k(t) {
          return b(t) && ("[object Error]" === j(t) || t instanceof Error);
        }
        function x(t) {
          return "function" == typeof t;
        }
        ...
        (e.debuglog = function (n) {
          if (
            (g(o) && (o = t.env.NODE_DEBUG || ""), (n = n.toUpperCase()), !s[n])
          )
    ...
    function (t, e, n) {
      ...
      var r = n(4),
        ...
        l = n(5),
        u =
          "\nAmit Singh Kushwaha\nFull Stack Web Developer\nReact / NodeJS / JavaScript / Python\n\nProjects\n--------\n\n\n* Saregama:                    https://amitsingh-5600.github.io/Saregama/   \n* Youtube_clone:               https//:github.com/AmitSingh-5600/Youtube_clone     \n* E-commerce-Website:  https//:github.com/AmitSingh-5600/E-commerce-Website-using-React \n\nand of course...\n\nSKILLS & WORKFLOW \n-----------\n\n* Comfortable with Git \n* Familar with modern Web Technologies like React.js and Node.js\n* Able to cope with the ever changing web landscape of syntax , APIs and frameworks\n* Had worked with these languages: JavaScript, HTML, CSS and Python\n\nContact\n-------\n\n* Github: https://github.com/AmitSingh-5600 \n* Email: amitsingh5600@gmail.com\n\n\n\n\n\n",
        f =
          '<a class="footer__link" href="#" id="pause-resume">Pause ||</a>\n<a class="footer__link" href="#" id="skip-animation">Skip Animation --\x3e</a>\n<span style="float:right">\n  <a class="footer__link" href="https://www.linkedin.com/in/amit-singh5600/">Linkedin</a>\n  <a class="footer__link" href="https://github.com/AmitSingh-5600">GitHub</a>\n\n\n\n</span>\n',
        p =
      ...
      function y(t, e, n) {
        var r = v[t.id];
        r || (r = v[t.id] = t.innerHTML),
          (r = E(r, e)),
          (t.innerHTML = v[t.id] = r),
          (_ += e),
          ";" === e && ((n.textContent += _), (_ = ""));
      }
      function g(t, e) {
      ...
      function E(t, e) {
        return (
          m && "/" !== e
            ...
            ? ((m = !0), (t += e))
            : "/" === e && "*" === t.slice(-1) && !0 === m
            ? ((m = !1), (t = t.replace(b, '<span class="comment">$1/</span>')))
            : ":" === e
            ? (t = t.replace(w, '<span class="key">$1</span>:'))
            : ";" === e
            ? (t = t.replace(k, '<span class="value">$1</span>;'))
            : "{" === e
            ? (t = t.replace(x, '<span class="selector">$1</span>{'))
            : "x" === e && j.test(t.slice(-2))
            ? (t = t.replace(C, '<span class="value px">px</span>'))
            : (t += e),
          t
        );
      }
      function T() {
        ...
        var g = (d.prototype = p.prototype = Object.create(_));
        function m(t) {
      ...
      var S,
        ...
        R,
        A,
        L = n.n(l).a.markdown.toHTML,
        I = [0, 1, 2, 3].map(function (t) {
          return n(13)("./styles" + t + ".css").default;
        }),
        D = "localhost" === window.location.hostname ? 0 : 16,
        H = !1,
        M = !1,
        N = !1;
      function $() {
              ...
              function (t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      return (
                        (t.prev = 0), (t.next = 3), q(F, I[0], 0, D, !0, 1)
                      );
                    case 3:
                      return (t.next = 5), q(O, u, 0, D, !1, 1);
                    case 5:
                      return (t.next = 7), q(F, I[1], 0, D, !0, 1);
                    case 7:
                      return Q(), (t.next = 10), c.a.delay(1e3);
                    case 10:
                      return (t.next = 12), q(F, I[2], 0, D, !0, 1);
                    case 12:
                      return (t.next = 14), q(F, I[3], 0, D, !0, 1);
                    case 14:
                      t.next = 23;
                      break;
                    case 16:
      ...
      document.addEventListener("DOMContentLoaded", function () {
        ...
        (A = (function () {
          ...
          (I = I.map(function (t) {
            return t.replace(/-webkit-/g, A);
          })),
          (document.getElementById("header").innerHTML = f),
          ((t = document.createElement("style")).textContent = p),
          document.head.insertBefore(
            t,
            document.getElementsByTagName("style")[0]
          ),
          (S = document.getElementById("style-tag")),
          (F = document.getElementById("style-text")),
          (O = document.getElementById("work-text")),
          (P = document.getElementById("skip-animation")),
          (R = document.getElementById("pause-resume")),
          ...
          R.addEventListener("click", function (t) {
            t.preventDefault(),
              N
                ? ((R.textContent = "Pause ||"), (N = !1))
                : ((R.textContent = "Resume >>"), (N = !0));
          }),
          (function () {
            $.apply(this, arguments);
          })();
            ...
            return T().wrap(function (t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  ...
                  case 15:
                    return t.abrupt("return", q(e, n, r, i, o, s));
                  case 16:
                  case "end":
                    return t.stop();
                }
                  ...
                  return T().wrap(function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        ...
                        case 2:
                          if (
                            ((i = O.classList.contains("flipped")),
                            (o = (O.scrollHeight - O.clientHeight) / 2),
                            !(i ? O.scrollTop < o : O.scrollTop > o))
                          ) {
                            e.next = 12;
                            break;
                          }
